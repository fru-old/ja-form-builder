...
function options(babelPlugins, webpackPlugins, postLoaders, reloadEntries, language, devtool, output) {
  ...
  var babel = {
    ...
    plugins: ['transform-es3-property-literals', 'transform-es3-member-expression-literals', 'transform-decorators-legacy'].concat(babelPlugins)
  };
...
module.exports = function (target) {
  ...
  if (target === 'dev') {
    ...
    var WebpackDevServer = proxyquire('webpack-dev-server', {
      'express': function () {
