...
SingleLineComponent.prototype.create = function (value) {
  ...
  $(this._input).on('keyup', () => this._triggerOnChange());
  $(this._input).on('paste', () => this._triggerOnChange());
  $(this._input).on('cut', () => this._triggerOnChange());
  $(this._input).on('change', () => this._triggerOnChange());
