...
export default class Card extends Component {
  ...
  render() {
    ...
    return connectDragSource(connectDropTarget(
        <div style={{opacity}} className="click-test">
          <span className="action"><i className="material-icons">launch</i></span>
          <span className="description" onClick={console.log('down'+this.props.row+'-'+this.props.column)} onMouseEnter={console.log('enter'+this.props.row+'-'+this.props.column)}>
