...
const drag = {
  ...
  toogleSelection: createAction('DRAG_TOOGLE_SELECTION'),
  openElementSettings: createAction('OPEN_ELEMENT'),
};
 ...
 *
 */
function toogleSelection(state, action) {
...
drag.reducer = {
  ...
  [drag.toogleSelection]: toogleSelection
};
